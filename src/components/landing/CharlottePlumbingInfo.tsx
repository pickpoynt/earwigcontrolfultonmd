...
const CharlottePlumbingInfo = () => {
    return (
        <section id="charlotte-plumbing-info" className="py-24 bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 relative overflow-hidden text-white">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 className="text-3xl md:text-5xl font-heading font-bold mb-6 italic text-blue-100">
